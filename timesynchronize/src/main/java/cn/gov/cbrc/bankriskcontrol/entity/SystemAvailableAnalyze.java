...
/**
 * The persistent class for the system_available_analyze database table.
 * 
 */
@Entity
@Table(name="system_available_analyze")
@NamedQuery(name="SystemAvailableAnalyze.findAll", query="SELECT s FROM SystemAvailableAnalyze s")
public class SystemAvailableAnalyze implements Serializable {
