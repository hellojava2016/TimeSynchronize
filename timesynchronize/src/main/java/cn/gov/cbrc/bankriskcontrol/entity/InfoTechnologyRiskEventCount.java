...
/**
 * The persistent class for the info_technology_risk_event_count database table.
 * 
 */
@Entity
@Table(name="info_technology_risk_event_count")
@NamedQuery(name="InfoTechnologyRiskEventCount.findAll", query="SELECT i FROM InfoTechnologyRiskEventCount i")
public class InfoTechnologyRiskEventCount implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long id;
	private String areaCode;
	private long count;//风险数量
	...
	public InfoTechnologyRiskEventCount() {
	}
	...
	public void copyReportDatas(InfoTechnologyRiskEventCount rate){
