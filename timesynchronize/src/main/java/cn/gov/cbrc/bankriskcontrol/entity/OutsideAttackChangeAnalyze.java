...
/**
 * The persistent class for the outside_attack_change_analyze database table.
 * 
 */
@Entity
@Table(name="outside_attack_change_analyze")
@NamedQuery(name="OutsideAttackChangeAnalyze.findAll", query="SELECT o FROM OutsideAttackChangeAnalyze o")
public class OutsideAttackChangeAnalyze implements Serializable {
	...
	public OutsideAttackChangeAnalyze() {
	}
