...
public class LogInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (url.equals("/bankriskcontrol/user/login.do"))
			return super.preHandle(request, response, handler);
		else if (url.equals("/bankriskcontrol/report/report/testreport.do"))
			return super.preHandle(request, response, handler);
		else if (url.equals("/bankriskcontrol/user/logout.do")){			
			...
			if (user == null) {
				response.sendRedirect("/bankriskcontrol");
				return false;
			} else {
				return super.preHandle(request, response, handler);
			}
