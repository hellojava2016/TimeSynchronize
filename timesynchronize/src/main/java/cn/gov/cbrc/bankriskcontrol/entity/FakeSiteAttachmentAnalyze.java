...
/**
 * The persistent class for the fake_site_attachment_analyze database table.
 * 
 */
@Entity
@Table(name="fake_site_attachment_analyze")
@NamedQuery(name="FakeSiteAttachmentAnalyze.findAll", query="SELECT f FROM FakeSiteAttachmentAnalyze f")
public class FakeSiteAttachmentAnalyze implements Serializable {
	...
	public FakeSiteAttachmentAnalyze() {
	}
