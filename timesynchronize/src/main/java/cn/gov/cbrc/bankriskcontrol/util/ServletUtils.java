...
public class ServletUtils {
	 ...
	 * @return
	 */
	public static boolean hasPermision(String permision){
		boolean flag = true;
		if(flag){
			HttpServletRequest request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();  
			Set<String> permisions=(Set<String>)request.getSession().getAttribute("permisions"); 
			return permisions.contains(permision);
		}
		Subject currentuser = SecurityUtils.getSubject();
		return currentuser.isPermitted(permision);
	}
