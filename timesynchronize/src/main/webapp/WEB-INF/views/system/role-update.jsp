  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      ...
      <div class="row show mb_10">
        <div class="span12">
          <h3 class="show_tit">修改角色</h3>
          <div class="show_conment">
            <form class="form-horizontal" id="roleform" role="form" action="${ctx}/role/update.do"  method="post">              
              <input id="roleId" type="hidden" value="${role.roleId}"/>              
                <div class="form-group">
                <label for="roleName" class="col-xs-4 control-label pr_0">角色名：</label>
                <div class="col-xs-5">
                  <input type="text" class="form-control" id="roleName" name="roleName" readonly value="${role.roleName}">
                </div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label  class="col-xs-4 control-label pr_0">权限选择：</label>
                <div class="col-xs-5">
                    <div class="showline">
                     <div id="jstree2"></div>
                   </div>
...
function updateRole(){
	if($("#roleform").valid()){
 		$.ajax({ url: "${ctx}/role/update.do", 
 			data:{
 				 "roleId": $("#roleId").val(),
				  "description": $("#description").val(),
				 "permisionstr": getSelectedPermisions()
 			},
 			success: function(msg){
 			if("1"==msg)
				 $.messager.alert("系统提示","对不起，你所赋予的角色已超过自身的角色，请联系管理员！");
			  else  
				  window.location.href="${ctx}/role/list.do";
 	      }});
