  ...
  <div class="login_main">
    ...
    <p align="center" id="showerror"></p>
      <form action="${ctx}/user/login.do" method="POST">
        ...
        <p class="frm"> <input id="rememberme" name="rememberme" type="checkbox" /><span>记住登录密码</span> </p>
        <div class="deng">
          <input id="loginid" type="button" value="登录" class="login" onclick="login()"/>
        </div>
      </form>
    </div>
  </div>
