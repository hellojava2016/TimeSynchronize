...
<div class="container"> 
  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      <div class="breadcrumb"><span>您当前所在的位置：</span> &gt; <a>系统管理</a> &gt; <a>公告查看</a></div>
      <div class="row show mb_10">
        <div class="span12">
          <h3 class="show_tit">修改公告</h3>
          <div class="show_conment">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-5">
                  <input type="text" class="form-control" id="username" name="username" value="${oldmessage.sendUser.name}" readonly>
                </div>
              </div>   
                ...
                <div class="col-xs-5">
                  <input type="text" class="form-control" id="title" name="title" value="${oldmessage.title}" readonly>
                </div>
              </div>       
              
              <div class="form-group">
              <label for="input" class="col-xs-4 control-label pr_0">紧急重要度：</label>
                <div class="col-xs-5">
                  <input type="text" class="form-control" id="criticalStr" name="criticalStr" value="${oldmessage.criticalStr}" readonly>
                </div>
              </div>        
              ...
              <div class="form-group">
                ...
                <div class="col-xs-5">
                 <textarea class="form-control" id="dmessage" name="dmessage" rows="10" readonly>${oldmessage.message}</textarea>
                </div>
              </div>              
            
               <div class="form-group">
                <label  class="col-xs-4 control-label pr_0">公告接收机构：</label>
                <div class="col-xs-5">
                    <div class="showline">
                     <div id="jstree2"></div>
                   </div>
                ...
                <div class="col-xs-5">                        
                        <button type="button" class="btn btn-default mr_20" onclick="window.location.href=document.referrer;">返回</button>
                </div>
              </div> 
            </form>
          </div>
