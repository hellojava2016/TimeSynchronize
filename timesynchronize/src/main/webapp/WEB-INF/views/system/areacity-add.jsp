      ...
      <div class="row show mb_10">
        <div class="span12">
          ...
          <div class="show_conment">
            <form class="form-horizontal" id="operform" action="<%=request.getContextPath()%>/areacity/add.do?parentid=${parentid}" method="post">                         
              <div class="form-group">
                <label for="input" class="col-xs-4 control-label pr_0">父区域名称：</label>
                <div class="col-xs-4">
                  <input type="text" class="form-control" id="pname" name="pname" value="${parentname}" disabled="disabled" >
                </div>
              </div> 
                <div class="form-group">
