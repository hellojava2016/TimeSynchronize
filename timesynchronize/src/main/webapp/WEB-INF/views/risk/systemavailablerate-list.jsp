...
var url = '${ctx}/report/systemavailablerate/upload.do';
$('#fileupload').fileupload({
    ...
    add: function (e, data) { 
    	 ...
    	 window.location.href = "${ctx}/report/systemavailablerate/list.do?message="+data.result;
    }
...
<div class="clearfix"></div>
	...
	<div class="pull-right">
		...
		<thead><tr><th><input type="checkbox" id="allroleselected" onclick="selectAll(this)"/></th><th>所属机构</th><th>指标类型</th><th>指标日期(期数)</th><th>是否补报</th><th>预期停止服务时间(分钟)</th><th>非预期停止服务时间(分钟)</th><th>提供服务总时间(分钟)</th></tr></thead>
		<tbody>
		<c:choose>
...
function deleteRates(){
	...
	$.messager.model = { 
	      ...
	      $.messager.confirm("系统提示", "您确定删除所选数据？", function() { 
	    	    ajaxOptions.url = "${ctx}/report/systemavailablerate/delete.do?";
	    		ajaxOptions.params = {	"pageNo":pageNo,"deleteids":deleteroleids};
	    		ajaxOptions.success = function(msg){
	    			window.location.href="${ctx}/report/systemavailablerate/query.do?"+getQueryParam();
	    	    };
...
function newreport(){
	window.location.href="${ctx}/report/systemavailablerate/add_pre.do";
}
function refresh(){
	window.location.href="${ctx}/report/systemavailablerate/query.do?"+getQueryParam();
}
function exportSystem(){
	window.location.href="${ctx}/report/systemavailablerate/export.do?"+getQueryParam();
}
