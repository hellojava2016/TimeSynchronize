...
<div class="container"> 
  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      <div class="breadcrumb"><span>您当前所在的位置：</span> &gt; <a>风险分析</a> &gt; <a>单机构多期指标监测</a></div>
      ...
      <div class="row show mb_10 " style="min-height:500px">
        <div class="span12">
          <div class="show_tit3">
           <div id="operateBtns">
	<div class="pull-left">
	<h4 class="showtit4">单机构多期指标监测</h4>
	</div>
...
var pageNo =${pageNo};
function refresh(){
	window.location.href="${ctx}/report/report/report2.do?"+getQueryParam();
}
function exportSystem(){
	window.location.href="${ctx}/report/report/export2.do?"+getQueryParam();
}
function getQueryParam(){
	...
	return "Organization="+Organization+"&startdate="+starttime+"&endtdate="+endtime+"&prov="+risktarget+"&pageNo="+pageNo+"&risktarget="+risktarget;
}
</script>
</body>
</html>