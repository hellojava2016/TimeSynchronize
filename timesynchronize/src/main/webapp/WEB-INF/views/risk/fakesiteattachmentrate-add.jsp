...
$("#city_5").citySelect({
	url:"<%=request.getContextPath()%>/report/fakesiteattachmentrate/gettypes.do?defaultChoose=true",
	prov:"4001",
	city:"",
	dist:"",
	nodata:"none"
  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      ...
      <div class="row show mb_10">
        <div class="span12">
          <h3 class="show_tit">假冒网站查封率</h3>
          <div class="show_conment">
            <form class="form-horizontal" role="form" id="fakeform" action="<%=request.getContextPath()%>/report/fakesiteattachmentrate/add.do" method="post">
              ...
              <div class="form-group">
                <label for="input" class="col-xs-4 control-label pr_0 require">假冒网站数量：</label>
                <div class="col-xs-4">
                  <input type="text" class="form-control" id="aofw"  name="aofw">
                </div>
              </div>
              <div class="form-group">
                <label for="input" class="col-xs-4 control-label pr_0 require">已查封数量：</label>
                <div class="col-xs-4">
                  <input type="text" class="form-control" id="cfw"  name="cfw">
                </div>
              </div>
