  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      ...
      <div class="row show mb_10">
        <div class="span12">
          <h3 class="show_tit">主要电子渠道交易变化率</h3>
          <div class="show_conment">
            <form class="form-horizontal" id="electronictransactionform" action="<%=request.getContextPath()%>/report/electronictransactionchangerate/add.do" method="post">
              ...
              <div class="form-group">
                <label for="input" class="col-xs-4 control-label pr_0 require">当前交易量：</label>
                <div class="col-xs-4">
...
<script type="text/javascript">
		$(function() {
			...
			$("#electronictransactionform").validate({
				rules : {
					reportdate : {
						required : true,
						date:true,
				...
				messages : {
					...
					count : {
						required : "请输入当前交易量",
						digits : "当前交易量必须为整数",
						max:"当前交易量不能超过100000000",
					}
				}
			});
			
			$("#city_5").citySelect({
				url:"<%=request.getContextPath()%>/report/electronictransactionchangerate/gettypes.do?defaultChoose=true",
				prov:"7001",
				city:"",
				dist:"",
				nodata:"none"
		...
		function toList() {
			window.location.href = "${ctx}/report/electronictransactionchangerate/list.do";
		}
