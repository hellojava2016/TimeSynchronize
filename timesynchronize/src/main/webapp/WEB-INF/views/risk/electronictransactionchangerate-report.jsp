...
<div class="container"> 
  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      <div class="breadcrumb"><span>您当前所在的位置：</span> <a>风险分析</a> &gt; <a>主要电子渠道交易变化率</a></div>
   <div class="row whitebackground mb_10">
               ...
               <div class="col-xs-12 row dpheight15"></div>
                 ...
                 <div class="col-xs-3 pr_0 pl_0 mr_10">  
                  <select name="reportorder"  class="selectcsss" id="reportorder">                      
                      <option value="4" <c:if test="${reportorder==4}">selected</c:if>>交易变化率-降序</option> 
                      <option value="5" <c:if test="${reportorder==5}">selected</c:if>>交易变化率-升序</option>                 
	...
	<div class="pull-right">
		...
		<thead><tr><th>所属机构</th><th>指标类型</th><th>指标日期(期数)</th><th>是否补报</th><th>当前交易量</th><th>交易变化率(%)</th></tr></thead>
		<tbody>
		<c:choose>
...
function refresh(){
	window.location.href="${ctx}/report/electronictransactionchangerate/report.do?"+getQueryParam();
}
</script>
</body>
</html>        