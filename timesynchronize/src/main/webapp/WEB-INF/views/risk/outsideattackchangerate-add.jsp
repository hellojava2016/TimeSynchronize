...
$(function (){
	...
	$("#city_5").citySelect({
		url:"<%=request.getContextPath()%>/report/outsideattackchangerate/gettypes.do?defaultChoose=true",
		prov:"5001",
		city:"",
		dist:"",
		nodata:"none"
	});
	$("#outsideform").validate({
		rules: {
			reportdate : {
				required : true,
				date:true,
		...
		messages: {
			...
			ipswp: {
				required: "请输入入侵检测系统告警数",
				digits:"入侵检测系统告警数必须为整数"
			},
			idswp: {
				required: "请输入入侵保护系统告警数",
				digits:"入侵保护系统告警数必须为整数"
			} 
		}
	});	 
	});	
  ...
  <div id="content" class="row mt_78">
    ...
    <div class="col-md-10" id="right">
      ...
      <div class="row show mb_10">
        <div class="span12">
          <h3 class="show_tit">外部攻击变化率</h3>
          <div class="show_conment">
            <form class="form-horizontal" role="form" id="outsideform" action="<%=request.getContextPath()%>/report/outsideattackchangerate/add.do" method="post">
              ...
              <div class="form-group">
                <label for="input" class="col-xs-4 control-label pr_0 require">入侵检测系统告警数：</label>
                <div class="col-xs-4">
                  <input type="text" class="form-control" id="idswp"  name="idswp">
                </div>
              </div>
              <div class="form-group">
                <label for="input" class="col-xs-4 control-label pr_0 require">入侵保护系统告警数：</label>
                <div class="col-xs-4">
                  <input type="text" class="form-control" id="ipswp"  name="ipswp">
                </div>
              </div>
